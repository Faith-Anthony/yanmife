  ...
  return (
    <section className="relative h-screen flex flex-col justify-center px-6 md:px-20 overflow-hidden bg-black">
      ...
      <div className="absolute top-28 left-12 md:left-24 flex items-center gap-2 z-20">
        ...
        <span className="text-xs font-mono tracking-widest text-red-600 uppercase font-bold">Rec</span>
      </div>
      ...
      <div className="absolute bottom-12 left-6 md:left-20 flex gap-10 font-mono text-[10px] text-zinc-500 uppercase tracking-widest z-20">
        <div><span className="text-zinc-700">ISO</span> 400</div>
        <div><span className="text-zinc-700">F-STOP</span> f/2.8</div>
        <div><span className="text-zinc-700">LOC</span> Sunderland, UK</div>
      </div>

      {/* SCROLL INDICATOR (Optional visual touch) */}
      <div className="absolute bottom-12 right-10 hidden md:block z-20">
        <div className="flex flex-col items-center gap-4">
          <span className="text-[8px] font-mono uppercase tracking-[0.3em] text-zinc-600 [writing-mode:vertical-lr]">Scroll</span>
